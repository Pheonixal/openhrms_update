...
def num2words(num):
    under_10 = ['ноль', 'бір', 'екі', 'үш', 'төрт', 'бес', 'алты', 'жеті', 'сегіз', 'тоғыз']
    teens = ['он', 'жиырма', 'отыз', 'қырық', 'елу', 'алпыс', 'жетпіс', 'сексен', 'тоқсан']
    above_100 = {100: 'жүз', 1000: 'мың', 1000000: 'миллион', 1000000000: 'миллиард'}

    if num < 10:
        return under_10[num]

    if num < 100:
        return teens[(int)(num / 10) - 1] + ('' if num % 10 == 0 else ' ' + under_10[num % 10])
